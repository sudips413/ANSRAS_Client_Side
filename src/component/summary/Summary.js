      ...
      <p className='summaryTitle mt-3 text-center'>|| SUMMARY || सारांश ||</p>
        ...
        <div class="text-input  mt-5">
               ...
               <p className='filesummary'>FILE SUMMARY</p> 
                <span id='nofile-error' className='error'></span>
                    <br/>
                    <input type="file" id="file" accept="text/plain" onChange={handleFile} required/>
                    
                    
                    <label for="file" class="btn btn-primary" style={{border:"2px dotted",borderRadius:"0px"}}><i class="fas fa-file" style={{color:"green"}}/> Upload txt File</label>
                    <br/>
                    ...
                    <button onClick={handleSubmit}  type="submit" class="btn btn-primary "><i className='fa  fa-arrow-right' style={{color:"orange"}}/>Summary</button>
                    <br/>
                    <br/>
